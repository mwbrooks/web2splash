...
exports.render = function(input, output, callback) {
    ...
    phantom.create(function(e, browser) {
        return browser.createPage(function(e, page) {
            return page.open(input, function(e, status) {
                if (status !== 'success') {
                    return callback(new Error('Could not open', input));
                }

                renderEachSplashScreen(page, output, function(e) {
...
var renderEachSplashScreen = function(page, output, callback) {
    ...
    setTimeout(function () {
        ...
        page.render(filepath, function(e) {
            renderEachSplashScreen(page, output, callback);
        });
    }, 200);
};
